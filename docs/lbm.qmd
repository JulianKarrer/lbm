...
<span class="x-label">Time Steps</span>
<span class="y-label">Velocity Amplitude</span>
</div>
...
## 1. Efficiently use Memory Bandwidth {auto-animate=true}
...
<span style="position: relative;
  ...
  text-align: center;
  width: 100%;
  display: inline-block;">Peak performance: 28.6 BLUPS (H100), 22.0 BLUPS(A100)</span>
...
<script>
    {   
        ...
        const layout = {
            ...
            // bargroupgap: 0.1, // gap between bars within group
        };
...
<script>
    {
        // Example data
        const xs = [1, 2, 4, 8];
        const ys = [1.0, 0.9986878599005695, 0.9895404565891907, 0.9796576024637036];
        const errors = [0.00045849417077719235, 0.0005705529725088642, 0.0006779119001179043, 0.00043811586968390913];
        const trace = {
            x: xs,
            y: ys,
            mode: 'lines+markers',
...
## 4. Over-optimization and Precision {auto-animate=true}
